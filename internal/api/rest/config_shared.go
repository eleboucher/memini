...
func clientSettingsToAPI(s store.ClientSettings) ClientSettings {
	out := ClientSettings{
		...
		InjectPretoolGateMs:      s.InjectPretoolGateMs,
		InjectDedupe:             s.InjectDedupe,
		InjectTelemetry:          s.InjectTelemetry,
		InjectCooldownMs:         s.InjectCooldownMs,
		InjectCooldownPrompts:    s.InjectCooldownPrompts,
		Recall:                   s.Recall,
		Capture:                  s.Capture,
